...
- how `--develop-step` can turn one target path into an interactive debugging loop
...
```bash
uv run --with playwright journey execute --file example/simple_journey/simple_journey.py --develop-step assert_local_file_contents
```
