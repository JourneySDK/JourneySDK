...
OK cli plan_journey | Journey stores and restores replayable step values whenever execution truly ...
...
OK cli plan_journey | Journey compiles the branch structure internally before execution. A normal run executes every generated case; a ...
...
OK cli plan_journey | Journey docs/branching_journey/branching_journey.py:branching_journey ...
OK cli plan_metadata | journey_id=branching_journey function_ref=... ...
OK cli plan_case | - case_1 branch_env={'bg_1': 'branch_1'} labels=['load_signup_request', 'classify_signup_request', 'assert_fast_track_path'] ...
OK cli plan_case | - case_2 branch_env={'bg_1': 'branch_2'} labels=['load_signup_request', 'classify_signup_request', 'assert_manual_review_path'] ...
...
OK executor step_start | step load_signup_request attempt=1 start
OK executor step_success | step load_signup_request attempt=1 ok duration=...
OK executor step_start | step classify_signup_request attempt=1 start
OK executor step_success | step classify_signup_request attempt=1 ok duration=...
OK executor branch_select |   branch bg_1=branch_2
OK executor step_start | step assert_manual_review_path attempt=1 start
OK executor step_success | step assert_manual_review_path attempt=1 ok duration=...
OK executor case_complete | - case_2 ok steps=3 duration=... stopped_at=assert_manual_review_path replay_anchor=classify_signup_request
...
OK cli execute_summary | Summary: 0 journeys executed, 0 cases executed, 0 failed ...
```
...
OK cli plan_journey | Journey restores that external state before the later branch continues from the ...
...
```console
OK cli plan_start | Plan
OK cli plan_journey | Journey docs/rehydration_journey/rehydration_journey.py:rehydration_journey ...
OK cli plan_metadata | journey_id=rehydration_journey function_ref=... ...
OK cli plan_case | - case_1 branch_env={'bg_1': 'branch_1'} labels=['prepare_context', 'shared_after_anchor', 'assert_branch_a'] ...
OK cli plan_case | - case_2 branch_env={'bg_1': 'branch_2'} labels=['prepare_context', 'shared_after_anchor', 'assert_branch_b'] ...
OK cli plan_summary | Summary: 1 journey planned, 2 cases planned, 0 failed ...

OK cli execution_section | Execution
OK executor case_start | - case_2 start branches={bg_1=branch_2}
OK executor step_success | step prepare_context attempt=1 ok duration=...
OK executor step_success | step shared_after_anchor attempt=1 ok duration=...
OK executor branch_select |   branch bg_1=branch_2
OK executor step_success | step assert_branch_b attempt=1 ok duration=...
OK executor case_complete | - case_2 ok steps=3 duration=... stopped_at=assert_branch_b replay_anchor=prepare_context
OK cli execute_summary | Summary: 1 journey executed, 1 case executed, 0 failed ...
```
