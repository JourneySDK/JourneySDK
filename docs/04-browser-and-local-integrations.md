...
OK cli plan_journey | Journey does not care whether a step talks to a browser, a file on disk, or a hosted webhook. If it is ordinary Python, it can live inside the same authored journey. ...
...
OK cli plan_journey | Journey docs/simple_journey/simple_journey.py:simple_journey ...
OK cli plan_metadata | journey_id=simple_journey function_ref=... ...
OK cli plan_case | - case_1 branch_env={'bg_1': 'branch_1'} labels=['assert_demo_homepage', 'get_webhook_endpoint_a', 'click_trigger_endpoint_a', 'receive_webhook_endpoint_a', 'assert_endpoint_a_webhook'] ...
OK cli plan_case | - case_2 branch_env={'bg_1': 'branch_2'} labels=['assert_demo_homepage', 'click_store_local_file', 'local_file_is_written', 'assert_local_file_contents'] ...
OK cli plan_summary | Summary: 1 journey planned, 2 cases planned, 0 failed ...

OK cli execution_section | Execution
OK executor case_start | - case_2 start branches={bg_1=branch_2}
OK executor step_success | step assert_demo_homepage attempt=1 ok duration=...
OK executor step_success | step click_store_local_file attempt=1 ok duration=...
OK executor step_success | step local_file_is_written attempt=1 ok duration=...
OK executor step_success | step assert_local_file_contents attempt=1 ok duration=...
OK executor case_complete | - case_2 ok steps=4 duration=... stopped_at=assert_local_file_contents replay_anchor=assert_demo_homepage
...
```console
OK cli plan_start | Plan
OK cli plan_journey | Journey docs/docker_compose_journey/docker_compose_journey.py:docker_compose_journey ...
OK cli plan_metadata | journey_id=docker_compose_journey function_ref=... ...
OK cli plan_case | - case_1 branch_env={'bg_1': 'branch_1'} labels=['run_docker', 'assert_stack_ready', 'capture_baseline_state', 'increment_counter', 'assert_increment_branch'] ...
OK cli plan_case | - case_2 branch_env={'bg_1': 'branch_2'} labels=['run_docker', 'assert_stack_ready', 'capture_baseline_state', 'read_counter_state', 'assert_restored_counter_branch'] ...
OK cli plan_summary | Summary: 1 journey planned, 2 cases planned, 0 failed ...

OK cli execution_section | Execution
OK executor case_start | - case_1 start branches={bg_1=branch_1}
OK executor step_success | step run_docker attempt=1 ok duration=...
OK executor step_success | step assert_stack_ready attempt=1 ok duration=...
OK executor step_success | step capture_baseline_state attempt=1 ok duration=...
OK executor step_success | step increment_counter attempt=1 ok duration=...
OK executor step_success | step assert_increment_branch attempt=1 ok duration=...
OK executor case_complete | - case_1 ok steps=5 duration=...
OK executor case_start | - case_2 start branches={bg_1=branch_2}
OK executor step_success | step read_counter_state attempt=1 ok duration=...
OK executor step_success | step assert_restored_counter_branch attempt=1 ok duration=...
OK executor case_complete | - case_2 ok steps=5 duration=...
OK cli execute_summary | Summary: 1 journey executed, 2 cases executed, 0 failed ...
```
...
```console
OK cli plan_start | Plan
OK cli plan_journey | Journey docs/playwright_resume_journey/playwright_resume_journey.py:playwright_resume_journey ...
OK cli plan_metadata | journey_id=playwright_resume_journey function_ref=... ...
OK cli plan_case | - case_1 branch_env={} labels=['login_and_capture_session', 'continue_authenticated_dashboard', 'assert_protected_action_complete'] ...
OK cli plan_summary | Summary: 1 journey planned, 1 case planned, 0 failed ...

OK cli execution_section | Execution
OK executor case_start | - case_1 start branches={}
OK executor step_success | step login_and_capture_session attempt=1 ok duration=...
OK executor step_start | step continue_authenticated_dashboard attempt=1 start
WARN cli graceful_interrupt_requested | interrupt requested; waiting for the active step to reach post-exit ...
OK executor step_success | step continue_authenticated_dashboard attempt=1 ok duration=...
...
```console
OK tutorial tutorial_note | Signed in and returned JourneyPlaywrightPage for http://127.0.0.1:.../dashboard. ...
OK tutorial tutorial_note | continue_authenticated_dashboard() reopened the saved dashboard at http://127.0.0.1:.../dashboard. ...
...
OK executor step_success | step assert_protected_action_complete attempt=1 ok duration=...
...
```console
OK tutorial tutorial_note | The protected action completed. If this run resumed from saved state, continue_authenticated_dashboard() restarted with the same saved JourneyPlaywrightPage instead of logging in again.
```
...
OK cli plan_journey | Journey SDK already includes Playwright and LangChain. Set your provider credentials with the normal provider ...
