...
def render_agent_bootstrap(target: str) -> str:
    ...
    return (
        ...
        "5. Use `journey logs`, traces, videos, text logs, JSONL, and touchpoint payloads as evidence.\n"
        ...
        "journey logs --list-log-sources --case <case_id> --step <target_step>\n"
        "journey logs --show --case <case_id> --step <target_step> --touchpoint docker --source <service> --tail 80\n"
        "journey logs --paths --step <target_step> --touchpoint browser\n"
        "```\n\n"
