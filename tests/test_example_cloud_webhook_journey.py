...
cloud_webhook_example = importlib.import_module(
    "example.cloud_webhook_journey.cloud_webhook_journey"
)
...
def test_cloud_webhook_example_compiles_without_touching_the_network(
    ...
    first_plan = journey.compile_journey(cloud_webhook_example.cloud_webhook_journey)
    second_plan = journey.compile_journey(cloud_webhook_example.cloud_webhook_journey)
...
def test_cloud_webhook_example_executes_against_local_journey_cloud(
    monkeypatch: pytest.MonkeyPatch,
):
    ...
    assert cloud_webhook_example.EVENTS == [
        "send_invoice_paid_webhook_later:"
